...
import com.example.api.driver.db.keys.DATABASECHANGELOGLOCK_PKEY
...
open class Databasechangeloglock(
     ...
     */
    public override fun getRecordType(): Class<DatabasechangeloglockRecord> = DatabasechangeloglockRecord::class.java
    ...
    public override fun getPrimaryKey(): UniqueKey<DatabasechangeloglockRecord> = DATABASECHANGELOGLOCK_PKEY
    public override fun `as`(alias: String): Databasechangeloglock = Databasechangeloglock(DSL.name(alias), this)
    public override fun `as`(alias: Name): Databasechangeloglock = Databasechangeloglock(alias, this)
    public override fun `as`(alias: Table<*>): Databasechangeloglock = Databasechangeloglock(alias.getQualifiedName(), this)

    /**
     * Rename this table
     */
    public override fun rename(name: String): Databasechangeloglock = Databasechangeloglock(DSL.name(name), null)

    /**
     * Rename this table
     */
    public override fun rename(name: Name): Databasechangeloglock = Databasechangeloglock(name, null)

    /**
     * Rename this table
     */
    public override fun rename(name: Table<*>): Databasechangeloglock = Databasechangeloglock(name.getQualifiedName(), null)
}
